public class InLab2 {
	...
	public static void testStock(){
		...
		System.out.println("Should print: : 1.1.1 values: 0, 0, 0, 0, 0, 0, 0");
		asset1.printStock();

		
		System.out.println("\nChecking Full Constructor:");
		...
		System.out.println("Should print: GOOGL: 15.5.2017 values: 0, 0, 0, 0, 0, 0, 0");
		asset2.printStock();
		...
		System.out.println("\nShould give print: FB: 15.5.2017 values: \n1007, 1010, 1013, 2000, 1019, 1022, 1025");
